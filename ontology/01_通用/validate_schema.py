...
class Validator:
    ...
    def validate_semiconductor_v2(self) -> None:
        domain_dir = WORKSPACE / "ontology/02_领域/semiconductor"
        domain_files = {
    ...
    def validate_docs_and_paths(self) -> None:
        ...
        for path in (WORKSPACE / "ontology/02_领域/semiconductor").glob("*.yaml"):
            data = load_yaml(path)
        ...
        template = load_yaml(WORKSPACE / "workflow/stages/02_结构" / "模板" / "02_任务本体视图模板.yaml")
        ...
        expected_domain_files = [
            "ontology/02_领域/semiconductor/common.yaml",
