...
- 成立案例：[`instances/02_V3样例/02_us-controls-localization-run-002/...`](../../../../../instances/02_V3样例/02_us-controls-localization-run-002/02_structure.yaml)。尚需失败案（份额升+新单点依赖）。`尚待两次真实任务验证`。
