...
4. 了解知识晋升：见 [`05_control_evaluation/01_rules/knowledge_promotion.md`](../../05_control_evaluation/01_rules/knowledge_promotion.md) 与其机器合同。
...
- 改完跑 `python3 05_control_evaluation/04_verifiers/validate_project.py`。
...
- 知识晋升写入口归 Control Plane 的 Rules
