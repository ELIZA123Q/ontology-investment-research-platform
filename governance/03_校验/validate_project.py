...
CHECKS = (
    ...
    ("Agent Skill 注册表", [sys.executable, "governance/03_校验/validate_agent_skill_registry.py"]),
    ("战略研究项目边界", [sys.executable, "governance/03_校验/validate_strategic_research_boundary.py"]),
    ("战略研究项目边界负向回归", [sys.executable, "governance/03_校验/tests/test_strategic_research_boundary.py"]),
    ...
    ("CEO战略报告模板结构", [sys.executable, "governance/03_校验/validate_ceo_strategy_report.py", "delivery/02_模板/05F_CEO战略报告模板.md"]),
    ("CEO战略报告结构负向回归", [sys.executable, "governance/03_校验/tests/test_ceo_strategy_report.py"]),
