...
def validate_repository() -> list[str]:
    ...
    runtime_schema = (ROOT / "runtime/engine/schemas.ts").read_text(encoding="utf-8")
    runtime_validator = (ROOT / "runtime/engine/reasoning_trace.ts").read_text(encoding="utf-8")
