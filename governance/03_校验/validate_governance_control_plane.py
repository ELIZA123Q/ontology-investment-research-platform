...
GOVERNANCE_ONTOLOGY_ROOT = ROOT / "governance/05_元治理本体"
...
FORMAL_MODEL_REGISTRY = ROOT / "ontology/01_通用/model_registry.yaml"
...
def validate_governance_control_plane(
    ...
    *,
    ...
    if instance_graph.get("ontology_ref") != "governance/05_元治理本体/model_registry.yaml":
