...
PUBLIC_CONTRACT_PATH = ROOT / "governance" / "02_合同" / "public_contract.yaml"
ROUTE_REGISTRY_PATH = ROOT / "governance" / "02_合同" / "judgment_method_routes.yaml"
ONTOLOGY_CONTRACT_PATH = ROOT / "ontology/01_通用" / "meta_schema.yaml"
ONTOLOGY_REASONING_PATH = ROOT / "ontology/01_通用" / "models" / "judgment.yaml"
KB02_REGISTRY_PATH = ROOT / "methods/02_判断结构" / "00_framework_dependency_registry.yaml"
KB03_REGISTRY_PATH = ROOT / "methods/03_取证" / "03_registry.yaml"
