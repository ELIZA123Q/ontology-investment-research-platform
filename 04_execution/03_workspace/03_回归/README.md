...
```bash
python3 05_governance/03_校验/snapshot_workbench_regression.py \
  04_execution/03_workspace/00_本机运行/exports/<run-id> \
  04_execution/03_workspace/03_回归/<fixture-name>
```
