...
半导体来源常覆盖不同产品、节点、晶圆尺寸和客户。任何“行业数据”进入核心待验证命题前，都要先确认分项能否与 02 的对象匹配。
...
本文件负责“选什么来源”；真实入口、查询步骤、字段口径和失败替代路线见配套的 [B03-IND-SEMI-OPS 半导体查询手册](B03-IND-SEMI-OPS_半导体真实来源查询与口径手册.md)。
