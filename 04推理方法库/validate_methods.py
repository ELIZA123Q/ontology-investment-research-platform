...
REQUIRED_FILES = {
    ...
    "A_单项判断裁决/A10_投资命题裁决.md": ["五道裁决门", "判断步骤", "判断结果", "不是投资建议"],
    "B_推理路径验证/B01_路径成立与逐段放行.md": ["每段六问", "路径状态"],
    "B_推理路径验证/B02_中间承接时滞与阻断.md": ["三类承接", "时滞裁决"],
    "B_推理路径验证/B03_规则适用与多路径合成.md": ["规则适用评价", "多路径如何合成"],
    "C_反证与竞争解释/C01_反证命中与裁决动作.md": ["反证先定位，再动作", "五步裁决"],
    "C_反证与竞争解释/C02_竞争解释比较.md": ["对称比较表", "判断处理"],
    "C_反证与竞争解释/C03_冲突证据裁决.md": ["真冲突还是表面冲突", "四种处理"],
    "D_改判与复盘/D01_改判触发与判断版本.md": ["改判是判断等级的状态迁移", "改判在首次成判时就写好", "五种版本动作", "投资命题的双重更新"],
    "D_改判与复盘/D02_历史复盘与方法反馈.md": ["第一版的定位", "反馈路由"],
    "01_判断模式库.md": ["旧链接兼容"],
