...
from quality_gate_utils import ALLOWED_04_OUTPUTS
...
GAP_STATUSES = {"open", "pending_review", "accepted", "rejected", "resolved"}
...
def validate(
    ...
    *,
    ...
    require_allowed(meta["status"], GAP_STATUSES, "status")
    ...
    require_allowed(meta["reasoning_output_ceiling"], ALLOWED_04_OUTPUTS, "reasoning_output_ceiling")
