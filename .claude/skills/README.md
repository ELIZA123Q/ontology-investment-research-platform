...
`07_runtime/src/capabilities/registry.ts`
...
- 产品能力：`07_runtime/src/capabilities/registry.ts`
- 治理索引：`03_capabilities/`（非实现镜像）
...
保持本目录不承载 Runtime Skill 正文或镜像，避免 `.claude`、`03_capabilities`、`07_runtime` 三套漂移。
