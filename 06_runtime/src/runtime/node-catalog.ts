...
export const RESEARCH_NODE_CATALOG: readonly ResearchNodeType[] = [
  ...
  { kind: "method_selection", capabilityType: "skill", capabilityId: "research-method", outputKind: "method_application", preconditions: [], invariants: ["每个方法 ID 必须来自受治理目录", "必须包含退出条件", "方法输入门未满足时不得伪装为已执行"], checkpointAfter: false },
