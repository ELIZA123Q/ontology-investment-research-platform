...
def main() -> int:
    ...
    sources = [
        ...
        "02_scenario_task/00_problem_graph/contract.yaml",
        ...
        "02_scenario_task/contracts/judgment_reasoning_commit_contract.yaml",
        ...
        "05_control_evaluation/01_rules/contracts/public_contract.yaml",
        "05_control_evaluation/03_permissions/permission_matrix.yaml",
        "05_control_evaluation/05_evals/registry.yaml",
        "05_control_evaluation/05_evals/protocols/report_quality_evaluation_contract.yaml",
    ...
    catalog = {
        ...
        "problemGraphContract": load_yaml("02_scenario_task/00_problem_graph/contract.yaml"),
        ...
        "judgmentCommit": load_yaml("02_scenario_task/contracts/judgment_reasoning_commit_contract.yaml"),
        "capabilities": {
        ...
        "governance": {
            ...
            "publicContract": load_yaml("05_control_evaluation/01_rules/contracts/public_contract.yaml"),
        ...
        "evaluation": {
            ...
            "reportQuality": load_yaml("05_control_evaluation/05_evals/protocols/report_quality_evaluation_contract.yaml"),
