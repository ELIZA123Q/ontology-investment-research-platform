...
一个帮研究员做投研判断的 AI 工作台。你提出研究目标，系统帮你拆解问题、收集证据、形成可追溯的判断、生成可审计的报告——整个过程每一步都有记录，结论可以回溯到原始来源。

## 这里是干什么的

这个项目是一个**投研推理平台**。简单说：

- 你在网页上输入一个研究目标（比如「某半导体公司的刻蚀设备业务竞争力如何」）
- 系统的 AI 助手（叫 Research Lead）帮你把目标拆成子问题，给出研究计划
