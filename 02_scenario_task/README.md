...
──────────────────────────────── (02 边界)
Research Lead → Runtime Planner → TaskGraph → Skill / Tool / Method
```
...
| [`90_legacy/`](90_legacy/) | 旧 Deep Research stages/templates 归档 |
...
2. 定任务边界与交付 → `03_tasks`
3. 需要规划先验 → `05_workflow_patterns`（不要把 legacy Deep Research 当主系统）
