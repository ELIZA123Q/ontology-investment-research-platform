...
| 想搞清 | 打开 |
|---|---|
| 评什么、不评什么 | [docs/01_评测总纲.md](docs/01_评测总纲.md) |
| 一个案例要准备什么 | [docs/02_案例与数据契约.md](docs/02_案例与数据契约.md) |
| AI 角色怎么跑 | [docs/03_评测流程与角色协议.md](docs/03_评测流程与角色协议.md) |
| 分数怎么算 | [04_指标口径与聚合规则.md](04_指标口径与聚合规则.md) |
| 命令、排错、发布检查 | [docs/05_运行与验收手册.md](docs/05_运行与验收手册.md) |
...
mock 只证明框架能跑，不代表真实研究质量。正式运行需配置真实生产模型、两个评测模型、两个下游模型，见 [运行手册](docs/05_运行与验收手册.md)。
