...
当分项口径已冻结、主测量与公司/下游验证满足 Recipe、反证已覆盖，继续增加同类研报或新闻不会改变 readiness 时停止。若关键专业数据因授权不可得，应明确是 `access_denied`，按 A09 建代理，而不是用大量弱来源拼接成强结论。
