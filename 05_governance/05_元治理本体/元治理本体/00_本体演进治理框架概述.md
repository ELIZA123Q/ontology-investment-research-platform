...
治理需要“本体化”，但不应成为第四个投研语义域。正确做法是在 `05_governance/` 内建立独立的元治理本体：它管理正式本体及其消费者，却不参与投研事实、证据和判断推理。
...
| 平面 | 权威位置 | 负责回答 | 禁止承担 |
|---|---|---|---|
| 投研语义面 | `01_semantic/01_ontology/` | 对象、状态、事件、证据、判断与研究场景 | 审批、权限、工作流、发布流程 |
| 治理控制面 | `05_governance/05_元治理本体/` | 资产权威、变更、影响、批准、检查、迁移、发布与审计 | 商业事实、投资结论、RuleEvaluation 依据 |
...
- 修改受治理资产：更新 `04_execution/03_workspace/governance_instance_graph.yaml`；旧资产目录只做兼容投影。
