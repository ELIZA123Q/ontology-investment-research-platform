...
REPO_ROOT = Path(__file__).resolve().parents[3]  # .../05_governance/14_evals/03_执行
...
def _bootstrap_eval_env_from_runtime_local() -> None:
    """Load 07_runtime/.env.local into EVAL_* when eval harness env is unset."""
    env_path = REPO_ROOT / "07_runtime" / ".env.local"
