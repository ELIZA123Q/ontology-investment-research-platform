...
def _validate_iteration_contract(view: dict[str, object]) -> None:
    ...
    if str(contract.get("convergence_contract_ref")) != "05_governance/02_合同/public_contract.yaml#iteration_semantics":
        fail("iteration_contract.convergence_contract_ref 必须引用公共合同 iteration_semantics")
    public = load_yaml_file(WORKSPACE / "05_governance/02_合同/public_contract.yaml")
