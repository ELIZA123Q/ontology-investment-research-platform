...
def _validate_domain_semantics(domain_doc: dict, graph: dict, errors: list[str]) -> None:
    ...
    domain_path = ROOT / "01_semantic/01_ontology/domains/semiconductor/business_instances.yaml"
...
def _scan_duplicate_authority(errors: list[str]) -> None:
    ...
    scan_roots = [
        ...
        *STAGE_SPEC_SCAN_ROOTS,
        ROOT / "05_governance",
        ROOT / "01_semantic/01_ontology",
        ROOT / "01_semantic/01_ontology/domains/semiconductor",
    ]
    for root in scan_roots:
        ...
        for path in root.rglob("*"):
            ...
            if "/tests/" in f"/{relative}/" or relative.startswith("05_governance/03_校验/tests/"):
                continue
...
def main() -> int:
    ...
    domain_dir = ROOT / "01_semantic/01_ontology/domains/semiconductor"
    ...
    matrix_path = ROOT / "05_governance" / "02_合同" / "parameter_authority_matrix.yaml"
