...
CONTRACT = ROOT / "05_governance/02_合同/knowledge_learning_contract.yaml"
ARCHITECTURE = ROOT / "05_governance/01_架构/03_知识沉淀闭环.md"
TYPESCRIPT = ROOT / "07_runtime/src/contracts.ts"
STORE = ROOT / "07_runtime/src/runtime/store.ts"
OBSERVATION_ROUTE = ROOT / "07_runtime/app/vnext/internal/knowledge/assets/[id]/observation/route.ts"
