...
- Python 3.12
- Node.js 24
- npm（使用 `07_runtime/package-lock.json`）

```bash
python3 -m pip install -r 05_governance/requirements.txt
...
python3 05_governance/03_校验/validate_v3_samples.py
...
- 公共字段、ID、跨阶段引用先改 `05_governance/02_合同/public_contract.yaml`，再同步 Runtime、校验器和样例。
