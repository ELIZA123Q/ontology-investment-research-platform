...
| 治理控制面 | `05_control_evaluation/06_change_governance/ontology/` | 资产权威、变更、影响、批准、检查、迁移、发布与审计 | 商业事实、投资结论、RuleEvaluation 依据 |
...
- 修改受治理资产：更新 `05_control_evaluation/06_change_governance/ontology/instances/governance_instance_graph.yaml`；旧资产目录只做兼容投影。
