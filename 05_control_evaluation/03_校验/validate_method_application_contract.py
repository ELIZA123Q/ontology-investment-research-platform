...
def validate_repository() -> list[str]:
    ...
    formal_gate_sources = {
        ROOT / "05_control_evaluation/03_校验/stages/stage_02/validate_02_outputs.py": "assert_valid_stage_applications",
        ROOT / "05_control_evaluation/03_校验/stages/stage_03/validate_03_outputs.py": "prior_items=view.get(\"method_applications\")",
        ROOT / "05_control_evaluation/03_校验/stages/stage_04/validate_04_outputs.py": "claim_register#{claim_id}",
        ROOT / "05_control_evaluation/03_校验/stages/stage_05/validate_05_outputs.py": "validate_expression_projection",
    }
