...
sys.path.insert(0, str(ROOT / "05_control_evaluation" / "03_校验" / "knowledge_graph"))
sys.path.insert(0, str(ROOT / "05_control_evaluation" / "03_校验" / "legacy_compat"))

from ontology_instance_graph import materialize_document
from validator_utils import load_yaml_file, split_refs

PUBLIC_CONTRACT_PATH = ROOT / "05_control_evaluation" / "02_合同" / "public_contract.yaml"
ROUTE_REGISTRY_PATH = ROOT / "05_control_evaluation" / "02_合同" / "judgment_method_routes.yaml"
ONTOLOGY_CONTRACT_PATH = ROOT / "01_semantic_knowledge/01_ontology" / "meta_schema.yaml"
ONTOLOGY_REASONING_PATH = ROOT / "01_semantic_knowledge/01_ontology" / "models" / "judgment.yaml"
KB02_REGISTRY_PATH = ROOT / "03_agent_capability/05_method_libraries/02_研究框架" / "registry.yaml"
KB03_REGISTRY_PATH = ROOT / "03_agent_capability/05_method_libraries/03_取证" / "03_registry.yaml"
