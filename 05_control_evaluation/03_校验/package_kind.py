...
Routing authority is 05_control_evaluation/02_合同/package_kinds.yaml#routing_rules.
"""
...
PACKAGE_KINDS_PATH = ROOT / "05_control_evaluation/02_合同/package_kinds.yaml"
...
VALIDATORS = {
    KIND_FORMAL: "05_control_evaluation/03_校验/validate_run.py",
    KIND_AUDIT: "05_control_evaluation/03_校验/validate_run.py",
    KIND_DELIVERY: "06_runtime/src/governance/verifiers.ts",
    KIND_KNOWLEDGE_BASELINE: "05_control_evaluation/03_校验/validate_semantic_baseline.py",
    KIND_KNOWLEDGE_TASK: "05_control_evaluation/03_校验/validate_semantic_baseline.py",
    KIND_V3: "05_control_evaluation/03_校验/validate_v3_samples.py",
    KIND_WORKBENCH: "05_control_evaluation/03_校验/validate_workbench_package.py",
}
