...
ASSET_PATH = ROOT / "03_agent_capability/05_method_libraries/00_登记/method_assets.yaml"
STRUCTURE_PATH = ROOT / "03_agent_capability/05_method_libraries/02_研究框架/registry.yaml"
EVIDENCE_PATH = ROOT / "03_agent_capability/05_method_libraries/03_取证/03_registry.yaml"
ROUTE_PATH = ROOT / "05_control_evaluation/02_合同/judgment_method_routes.yaml"
...
def build_method_catalog(
    ...
    for local_id, item in (evidence.get("methods") or {}).items():
        ...
        register(method_id, {
            ...
            "file": f"03_agent_capability/05_method_libraries/03_取证/{item.get('file', '')}",
    ...
    for item in adjudication_group.get("methods") or []:
        ...
        register(method_id, {
            ...
            "source_ref": f"03_agent_capability/05_method_libraries/00_登记/method_assets.yaml#groups.adjudication.methods.{method_id}",
            "file": item.get("file"),
