...
TEMPLATES = {
    "02": (ROOT / "02_scenario_task/04_workflows/deep_research/templates/02_任务本体视图模板.yaml", "3.0.0"),
    "03": (ROOT / "02_scenario_task/04_workflows/deep_research/templates/03_语义域与证据域实例清单模板.yaml", "3.0.0"),
    "04": (ROOT / "02_scenario_task/04_workflows/deep_research/templates/04_推理审计模板.yaml", "5.0.0"),
    "05": (ROOT / "03_agent_capability/05_method_libraries/05_表达/templates/05_表达审计模板.yaml", "3.0.0"),
}
SPECS = {
    "02": ROOT / "02_scenario_task/04_workflows/deep_research/stages/02_structure.md",
    "03": ROOT / "02_scenario_task/04_workflows/deep_research/stages/03_evidence.md",
    "04": ROOT / "02_scenario_task/04_workflows/deep_research/stages/04_judgment.md",
    "05": ROOT / "02_scenario_task/04_workflows/deep_research/stages/05_delivery.md",
}
...
def validate_repository() -> list[str]:
    ...
    package_kinds = yaml.safe_load((ROOT / "05_control_evaluation/02_合同/package_kinds.yaml").read_text(encoding="utf-8"))
    for kind in (
