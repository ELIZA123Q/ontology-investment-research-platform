...
VALIDATOR = ROOT / "05_control_evaluation/04_verifiers/ontology/validate_ontology.py"
spec = importlib.util.spec_from_file_location("validate_ontology", VALIDATOR)
...
class OntologyV3Tests(unittest.TestCase):
    ...
    def test_negative_fixtures_are_rejected(self) -> None:
        fixture_dir = ROOT / "05_control_evaluation/04_verifiers/fixtures/ontology_v3"
