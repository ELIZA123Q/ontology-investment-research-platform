...
VALIDATOR = ROOT / "05_control_evaluation/04_verifiers/validate_rule_authority.py"
...
class RuleAuthorityTests(unittest.TestCase):
    ...
    def test_formal_registry_must_match_formal_models(self) -> None:
        ...
        registry["formal_ontology_rules"]["kb04:A01"] = {
            "source_ref": "03_agent_capability/02_skills/judgment_reasoning/references/A01_状态判断.md",
