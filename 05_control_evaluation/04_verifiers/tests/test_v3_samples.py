...
VALIDATOR = ROOT / "05_control_evaluation/04_verifiers/validate_v3_samples.py"
...
class V3SampleTests(unittest.TestCase):
    def setUp(self) -> None:
        self.contract = validator.load(ROOT / "05_control_evaluation/01_rules/contracts/public_contract.yaml")
        self.rules = validator.known_rule_ids()
        self.run_dir = ROOT / "05_control_evaluation/04_verifiers/fixtures/reference_runs/research_runs/01_memory-cycle-run-002"
    ...
    def test_examples_pass(self) -> None:
        ...
        other = validator.load_run(ROOT / "05_control_evaluation/04_verifiers/fixtures/reference_runs/research_runs/02_us-controls-localization-run-002")
