...
ASSET_PATH = ROOT / "03_agent_capability/02_skills/method_assets.yaml"
STRUCTURE_PATH = ROOT / "03_agent_capability/02_skills/research_design/registry.yaml"
EVIDENCE_PATH = ROOT / "03_agent_capability/02_skills/evidence_research/registry.yaml"
ROUTE_PATH = ROOT / "05_control_evaluation/01_rules/policies/judgment_method_routes.yaml"
...
def build_method_catalog(
    ...
    for local_id, item in (evidence.get("methods") or {}).items():
        ...
        register(method_id, {
            ...
            "file": f"03_agent_capability/02_skills/evidence_research/references/{item.get('file', '')}",
    ...
    for item in adjudication_group.get("methods") or []:
        ...
        register(method_id, {
            ...
            "source_ref": f"03_agent_capability/02_skills/method_assets.yaml#groups.adjudication.methods.{method_id}",
            "file": item.get("file"),
