...
_JUDGMENT_MODEL_PATH = _ROOT / "01_semantic_knowledge" / "01_ontology" / "models" / "judgment.yaml"
_EVIDENCE_MODEL_PATH = _ROOT / "01_semantic_knowledge" / "01_ontology" / "models" / "evidence.yaml"
_THRESHOLD_POLICY_PATH = _ROOT / "05_control_evaluation" / "01_rules" / "policies" / "judgment_threshold_policy.yaml"
...
def evidence_profile_quality_floor(profile_id: str) -> str:
    ...
    profile_path = _ROOT / "01_semantic_knowledge" / "01_ontology" / "domains" / "semiconductor" / "business_instances.yaml"
