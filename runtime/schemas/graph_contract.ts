...
import { activeOntologyObjects, activeOntologyRelations } from "../skills/ontology/catalog_loader";
...
function catalog() {
  ...
  const profile = YAML.parse(readFileSync(repositoryPath("governance", "contracts", "runtime_supported_profile.yaml"), "utf8")) as RuntimeProfile;
