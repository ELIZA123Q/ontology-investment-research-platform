...
import type { EvidenceSupplementSummary } from "./supplement_view";

export type { EvidenceSupplementSummary } from "./supplement_view";
export { evidenceChangeBadge, evidenceChangeIds } from "./supplement_view";
