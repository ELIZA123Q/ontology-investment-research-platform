import { normalizeUrl, upsertSource } from "../../storage/db";
import { buildStage03AcquisitionQueries } from "./acquisition_planning";
import { selectEvidenceSnapshotExcerpt } from "./supplement_pure";
import {
...
export async function preAcquireStage03CandidateSources(input: {
  ...
  try {
    const search = input.search || (await import("../model_client/deepseek_client")).searchPublicWeb;
