  ...
  return (
    {
      ...
      episodeDerivedFromSource: "源自来源",
      claimSupportedByEpisode: "由片段支持",
      businessImpactFromJudgment: "基于判断",
      financialImpactFromBusinessImpact: "来自业务影响",
      estimateRevisionFromFinancialImpact: "来自财务影响",
      assetImpactFromFinancialImpact: "来自财务影响",
      assetImpactUsesEstimateRevision: "使用预测修正",
      traceIncludesNode: "纳入留痕",
      supports: "支持",
      weakens: "削弱",
      derivedFrom: "来自",
      basedOn: "依据",
