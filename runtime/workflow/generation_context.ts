        ...
        template_hint: deliveryArchetype === "industry_cycle_report"
          ...
          : deliveryArchetype === "event_commentary"
            ...
            : deliveryArchetype === "industry_dynamic_commentary"
              ? "knowledge/expression/templates/05B_行业动态点评模板.md"
              : deliveryArchetype === "company_earnings_commentary"
                ? "knowledge/expression/templates/05D_公司业绩点评模板.md"
                : deliveryArchetype === "theme_deep_dive"
                  ? "knowledge/expression/templates/05E_主题深度研究模板.md"
                  : "knowledge/expression/templates/05C_行业周期判断模板.md",
        expression_standard: "knowledge/expression/standards/05_投研表达标准.md",
