...
import { createRun, getWorkbenchDatabaseIdentity, getWorkbenchDb, withImmediateTransaction } from "./db";
import { latestArtifactPayload } from "./db_read_models";
...
function cohortDocument(): CohortDocument {
  ...
  const path = repositoryPath("evaluation", "07_研究员体验基线", "cohort.yaml");
