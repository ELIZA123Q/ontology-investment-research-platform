...
class RuntimeInstanceGraphTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.audit_path = ROOT / "instances/01_正式样例/02_管制与国产替代" / "04-美国管制与国产设备替代推理审计-20260715-1.yaml"
        cls.manifest_path = ROOT / "instances/01_正式样例/02_管制与国产替代" / "03-美国管制与国产设备替代语义域与证据域实例清单-20260715-1.yaml"
        cls.snapshot_dir = ROOT / "instances/01_正式样例/02_管制与国产替代" / "03-美国管制与国产设备替代数据与证据快照-20260715-1"
    ...
    def test_drivability_threshold_from_ontology(self) -> None:
        ...
        schema_path = ROOT / "ontology/01_通用" / "reasoning.yaml"
    ...
    def test_drivability_evidence_profile_instance(self) -> None:
        ...
        profile_path = ROOT / "ontology/02_领域/semiconductor" / "business_instances.yaml"
    ...
    def test_02_projects_downstream_views_for_03_04(self) -> None:
        ...
        view_path = ROOT / "instances/01_正式样例/02_管制与国产替代" / "02-美国管制与国产设备替代本体视图-20260715-1.yaml"
        ...
        baskets = ROOT / "instances/01_正式样例/02_管制与国产替代" / "03-美国管制与国产设备替代数据与证据快照-20260715-1" / "01_plan" / "evidence_baskets.csv"
        ...
        audit = yaml.safe_load(
            (ROOT / "instances/01_正式样例/02_管制与国产替代" / "04-美国管制与国产设备替代推理审计-20260715-1.yaml").read_text(encoding="utf-8")
        )
        judgment_count = sum(
