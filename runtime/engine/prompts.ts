...
export const PROMPT_VERSION="workbench-v1.3.3-method-routes";
...
- 新增来源使用新 SRC-xx source_key；补证来源必须提供可逐字核验的 source_quote 与 locator。
