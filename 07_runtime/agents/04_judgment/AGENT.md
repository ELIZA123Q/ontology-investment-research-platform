...
| 文件 | 用途 |
|------|------|
| `02_tasks/04_workflows/deep_research/stages/04_judgment.md` | 阶段规范与质量门槛 |
| `90_compat/methods/04_裁决/A00—A10/` | 裁决方法正文 |
| `05_governance/02_合同/judgment_threshold_policy.yaml` | 判断等级阈值政策（J0-J4 证据要求） |
| `05_governance/02_合同/judgment_method_routes.yaml` | 方法路由 |
| `05_governance/02_合同/rule_authority_registry.yaml` | 规则权威注册 |
| `01_semantic/01_ontology/models/` | 正式本体模型（规则、约束） |
