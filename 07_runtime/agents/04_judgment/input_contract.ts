...
import { projectClaimsFromJudgments } from "../../skills/semantic_review/artifact_read_adapter";
import {
...
export const STAGE04_QUALITY_GATE_REF =
  "02_tasks/04_workflows/deep_research/stages/04_judgment.md#6-质量门槛与返工";
