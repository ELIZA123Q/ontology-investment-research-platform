...
| 文件 | 用途 |
|------|------|
| `02_tasks/04_workflows/deep_research/stages/03_evidence.md` | 阶段规范与质量门槛 |
| `02_tasks/04_workflows/deep_research/supporting/03_evidence_provenance_manual.md` | 取数留痕操作手册 |
| `90_compat/methods/03_取证/B01_通用来源速查.md` | 通用来源→首选来源→MCP通道 |
| `90_compat/methods/03_取证/B02_半导体来源速查.md` | 半导体专用来源映射 |
| `90_compat/methods/03_取证/B03_MCP通道注册.md` | MCP通道完整注册表 |
| `90_compat/methods/03_取证/OPS_MCP查询快速参考.md` | MCP操作卡片 |
| `90_compat/methods/03_取证/A01—A09/` | 证据质量评价方法 |
