...
describe("portable knowledge package", () => {
  it("exports a self-describing formal baseline with checksums and no research payload", () => {
    ...
    expect(names.some((name) => name.startsWith("90_compat/ontology/models/") && name.endsWith(".yaml"))).toBe(true);
    expect(names).toContain("05_governance/05_元治理本体/method_assets.yaml");
