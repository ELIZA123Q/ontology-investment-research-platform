...
describe("release knowledge binding", () => {
  it("locks exact reusable knowledge identities without embedding research results", () => {
    ...
    }), input_context: JSON.stringify({ injected_assets: { knowledge_files: ["90_compat/knowledge/frameworks/README.md"] } }) });
    ...
    expect(lock.injected_knowledge_by_stage.stage_02).toContain("90_compat/knowledge/frameworks/README.md");
  });
});
