...
sys.path.insert(0, str(ROOT / "07_runtime" / "adapters"))
...
def _ontology_catalog() -> tuple[set[str], set[str]]:
    ...
    for filename in _MODEL_FILES:
        path = ROOT / "01_semantic/01_ontology/models" / filename
...
def _ontology_relation_definitions() -> dict[str, dict[str, Any]]:
    ...
    for filename in _MODEL_FILES:
        schema = load_yaml(ROOT / "01_semantic/01_ontology/models" / filename)
...
def build_iteration_plan(
    ...
    *,
    ...
    plan = {
        ...
        "ontology_authority": {
            "source": "01_semantic/01_ontology/models + 02 task_ontology_view",
