...
const defaultDb = resolve(repoRoot, "90_compat/instances/00_本机运行/workbench.sqlite");
...
const goldDir = resolve(repoRoot, "90_compat/instances/03_回归/02_memory-cycle-formal-pack");
