...
/**
 * 输出合同校验器 — 对标 05_governance/03_校验/ 体系
 *
 ...
 *
 * 同时定义结构化缺陷目录 (对标 90_compat/evaluation/03_执行/calibration/defects.yaml)
 */
 ...
 * 来源: 05_governance/03_校验/status_derivation.py DERIVED_LIMIT_FIELDS + RETIRED_PARALLEL_FIELDS
 */
...
// =============================================================================
// 第 2 部分: 结构化缺陷目录 (对标 90_compat/evaluation/03_执行/calibration/defects.yaml)
// =============================================================================
 ...
 * 来源: 90_compat/governance_mirrors/contracts/public_contract.yaml 主链定义
 */
