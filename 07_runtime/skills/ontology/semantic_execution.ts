...
export function loadBlockingSemanticRuleIds(): string[] {
  const registry = YAML.parse(
    readFileSync(repositoryPath("05_governance/02_合同/rule_authority_registry.yaml"), "utf8"),
  ) as {
...
/**
 * 状态派生矩阵 — 唯一权威来源: 90_compat/governance_mirrors/contracts/judgment_threshold_policy.yaml
 ...
 * 唯一权威: 07_runtime/engine/runtime_operations.yaml#CalculateConfidence
 *
