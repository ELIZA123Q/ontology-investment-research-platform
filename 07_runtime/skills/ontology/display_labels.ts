...
/** 判断类型中文：与 judgment.yaml allowed_values 及 90_compat/methods/02_判断结构/README §3.1 对齐。 */
...
export function formalStateVariableDisplayNames(): Map<string, string> {
  ...
  try {
    const file = repositoryPath("01_semantic", "01_ontology", "domains", "semiconductor", "business_instances.yaml");
