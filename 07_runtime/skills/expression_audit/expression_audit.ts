import "server-only";
import type { DefectType, StageDefectReport } from "../../schemas/output_contract";
import { DEFECT_DIMENSIONS, HARD_FAILURE_DEFECTS } from "../../schemas/output_contract";
 ...
 *
 * v2 增强 (对标 90_compat/evaluation/calibration/defects.yaml):
...
// =============================================================================
// v2 增强: 结构化缺陷检测 (对标 90_compat/evaluation/calibration/defects.yaml)
// =============================================================================
