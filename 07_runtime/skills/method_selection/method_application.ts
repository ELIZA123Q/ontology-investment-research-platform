...
import type { MethodApplication, MethodApplicationStatus, StageKind } from "../../schemas/types";
...
function loadExecutableMethodProfile(): ExecutableMethodProfile {
  ...
  const profile = YAML.parse(
    readFileSync(repositoryPath("05_governance", "02_合同", "runtime_supported_profile.yaml"), "utf8"),
