...
import { loadOntologyCatalog, type OntologyCatalog, type OntologyAttributeDefinition } from "../ontology/catalog_loader";
...
export function loadDataMappingRegistry(): DataMappingRegistry {
  ...
  const document = YAML.parse(readFileSync(
    repositoryPath("05_governance", "02_合同", "ontology_data_mapping_profiles.yaml"),
    "utf8",
