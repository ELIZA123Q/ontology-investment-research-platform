...
export default async function TaskKnowledgeGraphPage({ searchParams }: { searchParams: Promise<{ runId?: string; graph?: string }> }) {
  ...
  return <section className="knowledge-task-page">
    <KnowledgeRunSelector runs={runs} selectedRun={selectedRun} action="/90_compat/knowledge/task/graph"><span className="knowledge-question-help">本页回答：研究了谁？依据什么？怎样形成判断？用了哪些本体？</span></KnowledgeRunSelector>
