import { advanceOntologyChangeRequest } from "@/05_governance/ontology_changes/candidates_adapter";
    ...
    return Response.json(
      {
        ...
        deprecation: "Use POST /api/90_compat/ontology/changes/{requestId}/actions/{actionId}; next_status is a compatibility projection.",
      },
