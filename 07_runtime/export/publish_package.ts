...
import { getRun, listArtifacts, listSources, listWorkItems, latestArtifact, updateRun } from "../storage/db";
...
export function publishAndValidate(runId: string): PublishResult {
  ...
  const validator = repositoryPath("05_governance", "03_校验", "validate_workbench_package.py");
