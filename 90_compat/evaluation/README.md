...
```bash
python3 90_compat/evaluation/03_执行/validate_eval_set.py

python3 90_compat/evaluation/03_执行/eval_cli.py prepare --run-dir /tmp/research-eval
...
python3 90_compat/evaluation/03_执行/eval_cli.py aggregate --run-dir /tmp/research-eval
python3 90_compat/evaluation/03_执行/eval_cli.py report --run-dir /tmp/research-eval
```
