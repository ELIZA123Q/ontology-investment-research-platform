...
// 禁止：仅因对象同处 ResearchScope 推断 produces / supplies_to / contains / located_in。
// Knowledge Graph 可以补结构（如 scopeIncludesObject），不可以补业务事实。
// 见 01_semantic_knowledge/03_knowledge_graph/contracts/relation_policy.yaml。
