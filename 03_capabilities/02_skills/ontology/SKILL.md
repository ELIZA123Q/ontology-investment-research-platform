...
| 文件 | 用途 |
|------|------|
| `01_semantic/01_ontology/model_registry.yaml` | 正式本体模型注册表（机器权威） |
| `01_semantic/01_ontology/models/` | 正式模型 YAML 文件 |
| `01_semantic/01_ontology/*.md` | 通用本体人类说明 |
| `01_semantic/01_ontology/domains/semiconductor/` | 半导体领域扩展 |
| `05_governance/05_元治理本体/` | 元治理本体（本体演进规则） |
| `05_governance/02_合同/ontology_consumer_registry.yaml` | 本体消费者注册 |
