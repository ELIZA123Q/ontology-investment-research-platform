...
| 文件 | 用途 |
|------|------|
| `02_tasks/04_workflows/deep_research/stages/05_delivery.md` | 阶段规范与质量门槛 |
| `90_compat/methods/05_表达/standards/` | 表达语气、边界、结构标准 |
| `90_compat/methods/05_表达/templates/` | 05A—05E 报告模板 |
| `05_governance/02_合同/judgment_threshold_policy.yaml` | 判断等级→允许表达范围的映射 |
