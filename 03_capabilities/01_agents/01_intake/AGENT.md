...
| 文件 | 用途 |
|------|------|
| `02_tasks/04_workflows/deep_research/stages/01_intake.md` | 阶段规范与质量门槛 |
| `05_governance/02_合同/judgment_method_routes.yaml` | 判断方法路由 |
| `05_governance/02_合同/package_kinds.yaml` | 包类型定义 |
| `05_governance/01_架构/00_项目定位与边界.md` | 项目边界与超范围判定依据 |
| `01_semantic/01_ontology/` | 本体对象类型与关系定义 |
